...
FRAMEWORK_DIR = platform.get_package_dir("framework-obniz-plugin-esp32")
...
env.Append(
    ...
    FLASH_EXTRA_IMAGES=[
        ...
        ("0xe000", join(FRAMEWORK_DIR, "tools", "partitions", "obniz_boot.bin"))
    ]
)
...
partitions_csv = env.BoardConfig().get("build.partitions", "partitions_two_ota_coredump.csv")
env.Replace(
